...
public class MoverLocacionSO extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        if(agState.getlocacion().getAdyacente(Locacion.SUROESTE) != null && (agState.getenergiaInicial() - agState.getenergiaGastada()) >= COSTO_MOVERSE){
           	System.out.println("Ejecuta: SurOeste");
