...
public class MoverLocacionN extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        if(agState.getlocacion().getAdyacente(Locacion.NORTE) != null && (agState.getenergiaInicial() - agState.getenergiaGastada()) >= COSTO_MOVERSE){
           	System.out.println("Ejecuta: Norte");
        	agState.setlocacion(agState.getlocacion().getAdyacente(Locacion.NORTE));
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
        ...
        if(agState.getlocacion().getAdyacente(Locacion.NORTE) != null && (agState.getenergiaInicial() - agState.getenergiaGastada()) >= COSTO_MOVERSE){
        	...
        	environmentState.setlocacionDrone(environmentState.getlocacionDrone().getAdyacente(Locacion.NORTE));
