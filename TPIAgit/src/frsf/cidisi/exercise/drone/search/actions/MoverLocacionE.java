...
public class MoverLocacionE extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
        ...
        if(agState.getlocacion().getAdyacente(Locacion.ESTE) != null && (agState.getenergiaInicial() - agState.getenergiaGastada()) >= COSTO_MOVERSE){
        	System.out.println("Ejecuta: Este");
        	agState.setlocacion(agState.getlocacion().getAdyacente(Locacion.ESTE));
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
        ...
        if(agState.getlocacion().getAdyacente(Locacion.ESTE) != null && (agState.getenergiaInicial() - agState.getenergiaGastada()) >= COSTO_MOVERSE){
        	...
        	environmentState.setlocacionDrone(environmentState.getlocacionDrone().getAdyacente(Locacion.ESTE));
