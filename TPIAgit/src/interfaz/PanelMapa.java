...
public class PanelMapa extends JPanel {
	...
	//Se usan los métodos ya exitentes para graficar, solo q sin depender del mouseover.
	//Manejar variable "insimulation" que indicará cuál de las dos formas de graficar usamos.
	...
	public void paint (Graphics g){
		...
		for(Esquina e : esquinas){
			...
			try {
				//Si el mouse esta sobre una esquina, el método devolverá esa esquina
				...
				//De lo contrario, tirará esta excepción, y debemos hacer nada
			}
